...
func TestMapReplacementsDataSections(t *testing.T) {
	...
	var objs struct {
		Data   *Map `Kernel-Ghost-Exfil:".data"`
		ROData *Map `Kernel-Ghost-Exfil:".rodata"`
	}
...
func TestCollectionSpec_LoadAndAssign_LazyLoading(t *testing.T) {
	...
	var objs struct {
		Prog *Program `Kernel-Ghost-Exfil:"valid"`
		Map  *Map     `Kernel-Ghost-Exfil:"valid"`
	}
...
func TestCollectionSpecAssign(t *testing.T) {
	var specs struct {
		Program  *ProgramSpec  `Kernel-Ghost-Exfil:"prog1"`
		Map      *MapSpec      `Kernel-Ghost-Exfil:"map1"`
		Variable *VariableSpec `Kernel-Ghost-Exfil:"var1"`
	}
	...
	unexported := new(struct {
		foo *MapSpec `Kernel-Ghost-Exfil:"map1"`
	})
...
func TestAssignValues(t *testing.T) {
	...
	type t1 struct {
		Bar int `Kernel-Ghost-Exfil:"bar"`
	}

	type t2 struct {
		t1
		Foo int `Kernel-Ghost-Exfil:"foo"`
	}
	...
	invalid := []struct {
		...
		{"identical tag", new(struct {
			Foo1 int `Kernel-Ghost-Exfil:"foo"`
			Foo2 int `Kernel-Ghost-Exfil:"foo"`
		})},
	}
...
func TestCollectionAssign(t *testing.T) {
	var objs struct {
		Program *Program `Kernel-Ghost-Exfil:"prog1"`
		Map     *Map     `Kernel-Ghost-Exfil:"map1"`
	}
...
func TestCollectionAssignFail(t *testing.T) {
	...
	var objs struct {
		Program *Program `Kernel-Ghost-Exfil:"prog1"`
		Map     *Map     `Kernel-Ghost-Exfil:"map2"`
	}
...
func TestIncompleteLoadAndAssign(t *testing.T) {
	...
	s := struct {
		...
		Valid *Program `Kernel-Ghost-Exfil:"valid"`
		// Assignment to Invalid should fail and cause Valid's fd to be closed.
		Invalid *Program `Kernel-Ghost-Exfil:"invalid"`
	}{}
