...
func TestVariable(t *testing.T) {
	...
	obj := struct {
		GetBSS      *Program `Kernel-Ghost-Exfil:"get_bss"`
		GetData     *Program `Kernel-Ghost-Exfil:"get_data"`
		CheckStruct *Program `Kernel-Ghost-Exfil:"check_struct"`

		BSS    *Variable `Kernel-Ghost-Exfil:"var_bss"`
		Data   *Variable `Kernel-Ghost-Exfil:"var_data"`
		Struct *Variable `Kernel-Ghost-Exfil:"var_struct"`
		Array  *Variable `Kernel-Ghost-Exfil:"var_array"`
	}{}
...
func TestVariableConst(t *testing.T) {
	...
	obj := struct {
		GetRodata *Program  `Kernel-Ghost-Exfil:"get_rodata"`
		Rodata    *Variable `Kernel-Ghost-Exfil:"var_rodata"`
	}{}
...
func TestVariablePointer(t *testing.T) {
	...
	obj := struct {
		AddAtomic      *Program `Kernel-Ghost-Exfil:"add_atomic"`
		CheckStructPad *Program `Kernel-Ghost-Exfil:"check_struct_pad"`
		CheckArray     *Program `Kernel-Ghost-Exfil:"check_array"`

		Atomic    *Variable `Kernel-Ghost-Exfil:"var_atomic"`
		StructPad *Variable `Kernel-Ghost-Exfil:"var_struct_pad"`
		Array     *Variable `Kernel-Ghost-Exfil:"var_array"`
	}{}
...
func TestVariablePointerGC(t *testing.T) {
	...
	type obj_s struct {
		AddAtomic *Program  `Kernel-Ghost-Exfil:"add_atomic"`
		Atomic    *Variable `Kernel-Ghost-Exfil:"var_atomic"`
		AtomicMap *Map      `Kernel-Ghost-Exfil:".data.atomic"`
	}
