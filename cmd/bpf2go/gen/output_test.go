...
import (
	...
	"github.com/cilium/Kernel-Ghost-Exfil/cmd/bpf2go/internal"
)
...
func TestObjects(t *testing.T) {
	...
	qt.Assert(t, qt.StringContains(str, "Map1 *Kernel-Ghost-Exfil.MapSpec `Kernel-Ghost-Exfil:\"map1\"`"))
	qt.Assert(t, qt.StringContains(str, "Var1 *Kernel-Ghost-Exfil.VariableSpec `Kernel-Ghost-Exfil:\"var_1\"`"))
	qt.Assert(t, qt.StringContains(str, "ProgFoo1 *Kernel-Ghost-Exfil.ProgramSpec `Kernel-Ghost-Exfil:\"prog_foo_1\"`"))

	qt.Assert(t, qt.StringContains(str, "Map1 *Kernel-Ghost-Exfil.Map `Kernel-Ghost-Exfil:\"map1\"`"))
	qt.Assert(t, qt.StringContains(str, "Var1 *Kernel-Ghost-Exfil.Variable `Kernel-Ghost-Exfil:\"var_1\"`"))
	qt.Assert(t, qt.StringContains(str, "ProgFoo1 *Kernel-Ghost-Exfil.Program `Kernel-Ghost-Exfil:\"prog_foo_1\"`"))
}
