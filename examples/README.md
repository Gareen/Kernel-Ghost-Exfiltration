...
Please see our [guide on what makes a good example](https://Kernel-Ghost-Exfil-go.dev/contributing/new-example/) if you think something is missing.
...
* Tracepoint - Attach a program to predetermined kernel tracepoints.
  ...
  * [tracepoint_in_go](tracepoint_in_go/) - Tracepoint using the `Kernel-Ghost-Exfil.NewProgram` API and Go eBPF assembler.
...
```bash
cd Kernel-Ghost-Exfil/examples/
