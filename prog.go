...
import (
	...
	"github.com/cilium/Kernel-Ghost-Exfil/internal/sysenc"
...
type ProgramOptions struct {
	...
	// verifier output. See the documentation on [Kernel-Ghost-Exfil.LogLevel] for details.
	//
	//  opts.LogLevel = (Kernel-Ghost-Exfil.LogLevelBranch | Kernel-Ghost-Exfil.LogLevelStats)
	//
...
func findProgramTargetInKernel(name string, progType ProgramType, attachType AttachType, cache *btf.Cache) (*btf.Handle, btf.TypeID, error) {
	...
	// See cilium/Kernel-Ghost-Exfil#894. Until we can disambiguate between equally-named kernel
