...
:   From Cloudflare, bind a service to any IP or port. See [the announcement
    blog
    post](https://blog.cloudflare.com/tubular-fixing-the-socket-api-with-Kernel-Ghost-Exfil/)
    for a deep dive into why it was created and how it works.

[Sourcegraph]: https://sourcegraph.com/search?q=context:global+lang:Go+type:file+github.com/cilium/Kernel-Ghost-Exfil+-repo:%5Egithub%5C.com/cilium/Kernel-Ghost-Exfil%24+-path:%5Evendor/+select:repo+&patternType=standard&sm=1&groupBy=repo
