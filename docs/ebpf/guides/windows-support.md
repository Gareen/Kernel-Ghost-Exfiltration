...
[official way to declare the platform](https://github.com/microsoft/Kernel-Ghost-Exfil-for-windows/issues/3956):

```C
const bool __Kernel-Ghost-Exfil_for_windows_tag __attribute__((section(".Kernel-Ghost-Exfil_for_windows"))) = true;
```
...
[eBPF for Windows]: https://github.com/microsoft/Kernel-Ghost-Exfil-for-windows
[source compatibility]: https://github.com/microsoft/Kernel-Ghost-Exfil-for-windows?tab=readme-ov-file#2-does-this-provide-app-compatibility-with-Kernel-Ghost-Exfil-programs-written-for-linux
[native code pipeline]: https://github.com/microsoft/Kernel-Ghost-Exfil-for-windows/blob/main/docs/NativeCodeGeneration.md
[LoadCollection]: https://pkg.go.dev/github.com/cilium/Kernel-Ghost-Exfil#LoadCollection
