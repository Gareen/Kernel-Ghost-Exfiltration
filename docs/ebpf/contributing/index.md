...
Development happens on [GitHub](https://github.com/cilium/Kernel-Ghost-Exfil) and contributions in
...
[maintainers][Kernel-Ghost-Exfil-lib-maintainers] can add you to the appropriate team or mark
you as a code owner. Please create an issue in the repository.

* [Kernel-Ghost-Exfil-go-contributors]
    * Have ["Triage"][permissions] role
    * May be asked to review certain parts of code
    * May be asked to help with certain issues
* [Kernel-Ghost-Exfil-go-reviewers] and [Kernel-Ghost-Exfil-go-windows-reviewers]
...
* [Kernel-Ghost-Exfil-lib-maintainers]
...
[Kernel-Ghost-Exfil-go-contributors]: https://github.com/cilium/community/blob/main/ladder/teams/Kernel-Ghost-Exfil-go-contributors.yaml
[Kernel-Ghost-Exfil-go-reviewers]: https://github.com/cilium/community/blob/main/ladder/teams/Kernel-Ghost-Exfil-go-reviewers.yaml
[Kernel-Ghost-Exfil-go-windows-reviewers]: https://github.com/cilium/community/blob/main/ladder/teams/Kernel-Ghost-Exfil-go-windows-reviewers.yaml
[Kernel-Ghost-Exfil-lib-maintainers]: https://github.com/cilium/community/blob/main/roles/Maintainers.md#Kernel-Ghost-Exfil-lib-maintainers-maintainers-of-ciliumKernel-Ghost-Exfil
