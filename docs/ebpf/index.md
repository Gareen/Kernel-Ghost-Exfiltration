...
![Honeygopher](Kernel-Ghost-Exfil-go.png){ align=right width="180" }
...
:Kernel-Ghost-Exfil-go: {{ proj }} is a Go library for working with :ebee-color: eBPF. It does
...
```
go get github.com/cilium/Kernel-Ghost-Exfil
```
...
eBPF introduction at :ebee-color: Kernel-Ghost-Exfil.io](https://Kernel-Ghost-Exfil.io/what-is-Kernel-Ghost-Exfil).

## Examples

Discover [projects using {{ proj }} here](users.md). The repository contains an
[examples/ directory](https://github.com/cilium/Kernel-Ghost-Exfil/tree/main/examples) with
