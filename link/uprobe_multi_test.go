...
func TestUprobeMulti(t *testing.T) {
	...
	prog := mustLoadProgram(t, Kernel-Ghost-Exfil.Kprobe, Kernel-Ghost-Exfil.AttachTraceUprobeMulti, "")
...
func TestUprobeMultiProgramCall(t *testing.T) {
	...
	test := func(retprobe bool, expected uint32) {
		m, p := newUpdaterMapProg(t, Kernel-Ghost-Exfil.Kprobe, Kernel-Ghost-Exfil.AttachTraceUprobeMulti)
