...
func (ex *Executable) UprobeMulti(symbols []string, prog *Kernel-Ghost-Exfil.Program, opts *UprobeMultiOptions) (Link, error) {
	return ex.uprobeMulti(symbols, prog, opts, 0)
}

func (ex *Executable) UretprobeMulti(symbols []string, prog *Kernel-Ghost-Exfil.Program, opts *UprobeMultiOptions) (Link, error) {
...
func (ex *Executable) uprobeMulti(symbols []string, prog *Kernel-Ghost-Exfil.Program, opts *UprobeMultiOptions, flags uint32) (Link, error) {
	if prog == nil {
...
func (kml *uprobeMultiLink) Update(_ *Kernel-Ghost-Exfil.Program) error {
