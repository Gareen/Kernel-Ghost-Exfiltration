...
func (pl *perfEventLink) Update(_ *Kernel-Ghost-Exfil.Program) error {
...
func (pi *perfEventIoctl) Update(_ *Kernel-Ghost-Exfil.Program) error {
...
func attachPerfEvent(pe *perfEvent, prog *Kernel-Ghost-Exfil.Program, cookie uint64) (Link, error) {
	if prog == nil {
...
func attachPerfEventIoctl(pe *perfEvent, prog *Kernel-Ghost-Exfil.Program) (*perfEventIoctl, error) {
...
func attachPerfEventLink(pe *perfEvent, prog *Kernel-Ghost-Exfil.Program, cookie uint64) (*perfEventLink, error) {
