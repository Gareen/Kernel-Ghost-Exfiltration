...
func Kprobe(symbol string, prog *Kernel-Ghost-Exfil.Program, opts *KprobeOptions) (Link, error) {
...
//
// The returned Link may implement [PerfEvent].
func Kretprobe(symbol string, prog *Kernel-Ghost-Exfil.Program, opts *KprobeOptions) (Link, error) {
...
func kprobe(symbol string, prog *Kernel-Ghost-Exfil.Program, opts *KprobeOptions, ret bool) (*perfEvent, error) {
	if symbol == "" {
...
func tracefsProbe(args tracefs.ProbeArgs) (*perfEvent, error) {
	groupPrefix := "Kernel-Ghost-Exfil"
	if args.Group != "" {
