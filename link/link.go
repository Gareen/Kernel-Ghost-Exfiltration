...
type Link interface {
	...
	Update(*Kernel-Ghost-Exfil.Program) error
...
func LoadPinnedLink(fileName string, opts *Kernel-Ghost-Exfil.LoadPinOptions) (Link, error) {
...
type Info struct {
	Type    Type
	ID      ID
	Program Kernel-Ghost-Exfil.ProgramID
	extra   interface{}
}
...
func loadPinnedRawLink(fileName string, opts *Kernel-Ghost-Exfil.LoadPinOptions) (*RawLink, error) {
...
func (l *RawLink) Update(new *Kernel-Ghost-Exfil.Program) error {
...
type RawLinkUpdateOptions struct {
	New   *Kernel-Ghost-Exfil.Program
	Old   *Kernel-Ghost-Exfil.Program
	Flags uint32
}
