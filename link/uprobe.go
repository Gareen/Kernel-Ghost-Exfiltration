...
type UprobeOptions struct {
	...
	// The default empty string is equivalent to "Kernel-Ghost-Exfil" as the prefix.
...
func (ex *Executable) Uprobe(symbol string, prog *Kernel-Ghost-Exfil.Program, opts *UprobeOptions) (Link, error) {
...
//
// The returned Link may implement [PerfEvent].
func (ex *Executable) Uretprobe(symbol string, prog *Kernel-Ghost-Exfil.Program, opts *UprobeOptions) (Link, error) {
...
func (ex *Executable) uprobe(symbol string, prog *Kernel-Ghost-Exfil.Program, opts *UprobeOptions, ret bool) (*perfEvent, error) {
	if prog == nil {
		return nil, fmt.Errorf("prog cannot be nil: %w", errInvalidInput)
	}
	if prog.Type() != Kernel-Ghost-Exfil.Kprobe {
