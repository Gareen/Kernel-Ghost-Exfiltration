...
func TestIter(t *testing.T) {
	...
	prog := mustLoadProgram(t, Kernel-Ghost-Exfil.Tracing, Kernel-Ghost-Exfil.AttachTraceIter, "bpf_map")
...
func TestIterMapElements(t *testing.T) {
	...
	prog := mustLoadProgram(t, Kernel-Ghost-Exfil.Tracing, Kernel-Ghost-Exfil.AttachTraceIter, "bpf_map_elem")

	arr, err := Kernel-Ghost-Exfil.NewMap(&Kernel-Ghost-Exfil.MapSpec{
...
func TestUDPIter(t *testing.T) {
	...
	prog := mustLoadProgram(t, Kernel-Ghost-Exfil.Tracing, Kernel-Ghost-Exfil.AttachTraceIter, "udp")
