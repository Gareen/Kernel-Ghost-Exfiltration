...
func TestKprobeMulti(t *testing.T) {
	...
	prog := mustLoadProgram(t, Kernel-Ghost-Exfil.Kprobe, Kernel-Ghost-Exfil.AttachTraceKprobeMulti, "")
...
func TestKprobeMultiInput(t *testing.T) {
	...
	prog := mustLoadProgram(t, Kernel-Ghost-Exfil.SocketFilter, 0, "")
...
func TestKprobeMultiProgramCall(t *testing.T) {
	...
	m, p := newUpdaterMapProg(t, Kernel-Ghost-Exfil.Kprobe, Kernel-Ghost-Exfil.AttachTraceKprobeMulti)
...
func TestKprobeSession(t *testing.T) {
	...
	prog := mustLoadProgram(t, Kernel-Ghost-Exfil.Kprobe, Kernel-Ghost-Exfil.AttachTraceKprobeSession, "")
