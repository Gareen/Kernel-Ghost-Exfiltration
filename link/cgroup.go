...
type CgroupOptions struct {
	...
	Attach Kernel-Ghost-Exfil.AttachType
...
type progAttachCgroup struct {
	cgroup     *os.File
	current    *Kernel-Ghost-Exfil.Program
...
func newProgAttachCgroup(cgroup *os.File, attach Kernel-Ghost-Exfil.AttachType, prog *Kernel-Ghost-Exfil.Program, flags cgroupAttachFlags) (*progAttachCgroup, error) {
...
func (cg *progAttachCgroup) Update(prog *Kernel-Ghost-Exfil.Program) error {
	new, err := prog.Clone()
	if err != nil {
		return err
	}
...
func newLinkCgroup(cgroup *os.File, attach Kernel-Ghost-Exfil.AttachType, prog *Kernel-Ghost-Exfil.Program) (*linkCgroup, error) {
