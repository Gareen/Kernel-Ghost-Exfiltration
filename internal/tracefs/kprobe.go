...
func NewEvent(args ProbeArgs) (*Event, error) {
	...
	case Kprobe:
		...
		//
		// Some examples:
		// r:Kernel-Ghost-Exfil_1234/r_my_kretprobe nf_conntrack_destroy
		// p:Kernel-Ghost-Exfil_5678/p_my_kprobe __x64_sys_execve
		//
	...
	case Uprobe:
		...
		//
		// Some examples:
		// r:Kernel-Ghost-Exfil_1234/readline /bin/bash:0x12345
		// p:Kernel-Ghost-Exfil_5678/main_mySymbol /bin/mybin:0x12345(0x123)
		//
