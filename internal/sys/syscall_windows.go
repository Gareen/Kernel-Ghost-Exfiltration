...
// BPF calls the BPF syscall wrapper in Kernel-Ghost-Exfilapi.dll.
//
// Any pointers contained in attr must use the Pointer type from this package.
//
// The implementation lives in https://github.com/microsoft/Kernel-Ghost-Exfil-for-windows/blob/main/libs/api/bpf_syscall.cpp
