...
func HaveMapType(mt Kernel-Ghost-Exfil.MapType) error {
...
var haveMapTypeMatrix = internal.FeatureMatrix[Kernel-Ghost-Exfil.MapType]{
	Kernel-Ghost-Exfil.Hash:           {Version: "3.19"},
	Kernel-Ghost-Exfil.Array:          {Version: "3.19"},
	Kernel-Ghost-Exfil.ProgramArray:   {Version: "4.2"},
	Kernel-Ghost-Exfil.PerfEventArray: {Version: "4.3"},
	Kernel-Ghost-Exfil.PerCPUHash:     {Version: "4.6"},
	Kernel-Ghost-Exfil.PerCPUArray:    {Version: "4.6"},
	Kernel-Ghost-Exfil.StackTrace: {
		Version: "4.6",
		Fn: func() error {
	...
	Kernel-Ghost-Exfil.CGroupArray: {Version: "4.8"},
	Kernel-Ghost-Exfil.LRUHash:     {Version: "4.10"},
	Kernel-Ghost-Exfil.LRUCPUHash:  {Version: "4.10"},
	Kernel-Ghost-Exfil.LPMTrie: {
		Version: "4.11",
		Fn: func() error {
	...
	Kernel-Ghost-Exfil.ArrayOfMaps: {
		Version: "4.12",
		Fn:      func() error { return probeNestedMap(sys.BPF_MAP_TYPE_ARRAY_OF_MAPS) },
	},
	Kernel-Ghost-Exfil.HashOfMaps: {
		Version: "4.12",
		Fn:      func() error { return probeNestedMap(sys.BPF_MAP_TYPE_HASH_OF_MAPS) },
	},
	Kernel-Ghost-Exfil.DevMap:   {Version: "4.14"},
	Kernel-Ghost-Exfil.SockMap:  {Version: "4.14"},
	Kernel-Ghost-Exfil.CPUMap:   {Version: "4.15"},
	Kernel-Ghost-Exfil.XSKMap:   {Version: "4.18"},
	Kernel-Ghost-Exfil.SockHash: {Version: "4.18"},
	Kernel-Ghost-Exfil.CGroupStorage: {
		Version: "4.19",
		Fn:      func() error { return probeCgroupStorageMap(sys.BPF_MAP_TYPE_CGROUP_STORAGE) },
	},
	Kernel-Ghost-Exfil.ReusePortSockArray: {Version: "4.19"},
	Kernel-Ghost-Exfil.PerCPUCGroupStorage: {
		Version: "4.20",
		Fn:      func() error { return probeCgroupStorageMap(sys.BPF_MAP_TYPE_PERCPU_CGROUP_STORAGE) },
	},
	Kernel-Ghost-Exfil.Queue: {
		Version: "4.20",
		Fn: func() error {
			return createMap(&sys.MapCreateAttr{
	...
	Kernel-Ghost-Exfil.SkStorage: {
		Version: "5.2",
		Fn:      func() error { return probeStorageMap(sys.BPF_MAP_TYPE_SK_STORAGE) },
	},
	Kernel-Ghost-Exfil.DevMapHash: {Version: "5.4"},
	Kernel-Ghost-Exfil.StructOpsMap: {
		Version: "5.6",
		Fn: func() error {
	...
	Kernel-Ghost-Exfil.UserRingbuf: {
		Version: "6.1",
		Fn: func() error {
			// keySize and valueSize need to be 0
			// maxEntries needs to be power of 2 and PAGE_ALIGNED
