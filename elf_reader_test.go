...
func TestDataSections(t *testing.T) {
	...
	var obj struct {
		Program *Program `Kernel-Ghost-Exfil:"data_sections"`
	}
...
func TestInlineASMConstant(t *testing.T) {
	...
	var obj struct {
		Program *Program `Kernel-Ghost-Exfil:"asm_relocation"`
	}
...
func TestFreezeRodata(t *testing.T) {
	...
	var obj struct {
		Program *Program `Kernel-Ghost-Exfil:"freeze_rodata"`
	}
...
func TestTailCall(t *testing.T) {
	...
	var obj struct {
		TailMain  *Program `Kernel-Ghost-Exfil:"tail_main"`
		ProgArray *Map     `Kernel-Ghost-Exfil:"prog_array_init"`
		...
		Tail *Program `Kernel-Ghost-Exfil:"tail_1"`
	}
...
func TestKconfig(t *testing.T) {
	...
	var obj struct {
		Main *Program `Kernel-Ghost-Exfil:"kconfig"`
	}
...
func TestKsym(t *testing.T) {
	...
	var obj struct {
		Main     *Program `Kernel-Ghost-Exfil:"ksym_test"`
		ArrayMap *Map     `Kernel-Ghost-Exfil:"array_map"`
	}
...
func TestKsymWeakMissing(t *testing.T) {
	...
	var obj struct {
		Main *Program `Kernel-Ghost-Exfil:"ksym_missing_test"`
	}
...
func TestKfunc(t *testing.T) {
	...
	var obj struct {
		Main *Program `Kernel-Ghost-Exfil:"call_kfunc"`
	}
...
func TestWeakKfunc(t *testing.T) {
	...
	testutils.WithCapabilities(t, []testutils.Capability{testutils.CAP_BPF, testutils.CAP_PERFMON}, func() {
		...
		var obj struct {
			Missing *Program `Kernel-Ghost-Exfil:"weak_kfunc_missing"`
			Calling *Program `Kernel-Ghost-Exfil:"call_weak_kfunc"`
		}
...
func TestSubprogRelocation(t *testing.T) {
	...
	var obj struct {
		Main    *Program `Kernel-Ghost-Exfil:"fp_relocation"`
		HashMap *Map     `Kernel-Ghost-Exfil:"hash_map"`
	}
...
func TestLibBPFCompat(t *testing.T) {
	...
	testutils.Files(t, files, func(t *testing.T, path string) {
		...
		case "netif_receive_skb",
			...
			// See https://github.com/cilium/Kernel-Ghost-Exfil/issues/739
