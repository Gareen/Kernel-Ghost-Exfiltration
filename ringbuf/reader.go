...
func NewReader(ringbufMap *Kernel-Ghost-Exfil.Map) (*Reader, error) {
	if ringbufMap.Type() != Kernel-Ghost-Exfil.RingBuf && ringbufMap.Type() != Kernel-Ghost-Exfil.WindowsRingBuf {
