...
func outputSamples(tb testing.TB, events *Kernel-Ghost-Exfil.Map, sampleSizes ...byte) {
...
func outputSamplesProg(tb testing.TB, events *Kernel-Ghost-Exfil.Map, sampleSizes ...byte) *Kernel-Ghost-Exfil.Program {
	tb.Helper()
...
func bpfPerfEventOutputProgram() (*Kernel-Ghost-Exfil.Program, *Kernel-Ghost-Exfil.Map) {
	return nil, nil
}
...
func perfEventArray(tb testing.TB) *Kernel-Ghost-Exfil.Map {
